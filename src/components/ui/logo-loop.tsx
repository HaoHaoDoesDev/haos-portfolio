...
export interface LogoLoopProps {
  ...
  whiteLogos?: boolean; // New prop to control white logos
}
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    className,
    style,
    whiteLogos = false, // Default to false to maintain original behavior
  }) => {
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              ...
              whiteLogos && "[filter:brightness(0)_invert(1)]", // Make white for node items
              scaleOnHover &&
          ...
          <img
            className={cx(
              ...
              "motion-reduce:transition-none",
              whiteLogos && "[filter:brightness(0)_invert(1)]", // Make white for image items
              scaleOnHover &&
                "transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120",
            )}
            src={(item as any).src}
